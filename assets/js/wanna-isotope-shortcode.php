        ...
        if ( $isotope_loop->have_posts() ) :
            ...
            <ul id="filters-<?php echo esc_attr( $id ); ?>" class="filters">
                ...
                <li>
                    ...
                    <a href="javascript:void(0)" title="filter all" data-filter=".urbanizaciones">
                        <?php esc_html_e( 'Urbanizaciones', 'wanna-isotope' ); ?>
                    </a>
                </li>
                    <a href="javascript:void(0)" title="filter all" data-filter=".complejos-edilicios">
                        <?php esc_html_e( 'Complejos Edilicios', 'wanna-isotope' ); ?>
                    </a>
                </li>
                    <a href="javascript:void(0)" title="filter all" data-filter=".obras-civiles">
                        <?php esc_html_e( 'Obras diviles', 'wanna-isotope' ); ?>
                    </a>
                </li>
                    <a href="javascript:void(0)" title="filter all" data-filter=".sector-rural">
                        <?php esc_html_e( 'Sector Rural', 'wanna-isotope' ); ?>
                    </a>
                </li>
                    <a href="javascript:void(0)" title="filter all" data-filter=".shopping-centers">
                        <?php esc_html_e( 'Shopping Centers', 'wanna-isotope' ); ?>
                    </a>
                </li>
